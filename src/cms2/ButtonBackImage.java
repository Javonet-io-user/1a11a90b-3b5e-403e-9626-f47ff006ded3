...
public class ButtonBackImage extends PictureBox
  ...
  public void setSizeMode(PictureBoxSizeMode value) {
    try {
      javonetHandle.set("SizeMode", NEnum.fromJavaEnum(value));
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public PictureBoxSizeMode getSizeMode() {
    try {
      Object res = javonetHandle.<NEnum>get("SizeMode");
      if (res == null) return null;
      return PictureBoxSizeMode.valueOf(((NEnum) res).getValueName());
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public ButtonBackImage(NObject handle) {
    super(handle);

...
public class SelectDate extends Form
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setSelectDate(DateTime value) {
    try {
      javonetHandle.set("SelectDate", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public DateTime getSelectDate() {
    try {
      Object res = javonetHandle.<NObject>get("SelectDate");
      if (res == null) return null;
  ...
  public SelectDate() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("cms2.SelectDate");
  ...
  public SelectDate(NObject handle) {
    super(handle);
